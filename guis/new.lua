...
scarcitybanner.Text = 'Join CarbonV4 server to report any bugs or suggest any features! discord.gg/8sjEsjFVZa'
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/jackwallhack8/Carbon/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
